...
void glMatrix4fZero              (GLfloat*);
void glMatrix4dZero              (GLdouble*);
void glMatrix4fIdentity          (GLfloat*);
void glMatrix4dIdentity          (GLdouble*);
void glMatrix4fTimes             (GLfloat*,  GLfloat*,  GLfloat*);
void glMatrix4dTimes             (GLdouble*, GLdouble*, GLdouble*);
void glMatrix4dConcat            (GLdouble*, GLdouble*, GLdouble*, GLenum);
void glMatrix4fTranspose         (GLfloat*,  GLfloat*);
void glMatrix4dTranspose         (GLdouble*, GLdouble*);
void glMatrix4fTransVector3f     (GLfloat*,  GLfloat*,  GLfloat*);
void glMatrix4dTransVector3d     (GLdouble*, GLdouble*, GLdouble*);
void glMatrix4dTransVector4d     (GLdouble*, GLdouble*, GLdouble*);
void TV3M4                       (GLdouble*, GLdouble*, GLdouble*);
void glMatrix4fInvTransVector3f  (GLfloat*,  GLfloat*,  GLfloat*);
void glMatrix4dInvTransVector3d  (GLdouble*, GLdouble*, GLdouble*);
void glCreateScalingMatrix4f     (GLfloat*,  GLfloat*);
void glCreateScalingMatrix4d     (GLdouble*, GLdouble*);
void glCreateTranslationMatrix4f (GLfloat*,  GLfloat*);
void glCreateTranslationMatrix4d (GLdouble*, GLdouble*);
void glCreateRotationMatrix4f    (GLfloat*,  GLfloat*);
void glCreateRotationMatrix4d    (GLdouble*, GLdouble*);
void glMatrix4dRotationLine      (GLdouble*, GLdouble, GLdouble*, GLdouble*);
void glMatrix4fInverse           (GLfloat*,  GLfloat*);
void glMatrix4dInverse           (GLdouble*, GLdouble*);
