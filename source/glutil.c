...
EXPORT void APIENTRY gluOrtho2D
...
EXPORT void APIENTRY gluPerspective
...
EXPORT void APIENTRY gluPickMatrix
...
EXPORT int APIENTRY gluProject (GLdouble objx, GLdouble objy, GLdouble objz,
 const GLdouble momatrix[16], const GLdouble prmatrix[16], const GLint viewport[4],
 GLdouble* winx, GLdouble* winy, GLdouble* winz)
{
  ...
  // Check pointers
  if (momatrix==NULL || prmatrix==NULL || winx==NULL || winy==NULL || winz==NULL)
  {
 ...
 GLdouble* objx, GLdouble* objy, GLdouble* objz)
{
  ...
  // Check pointers
  if (momatrix==NULL || prmatrix==NULL || objx==NULL || objy==NULL || objz==NULL)
  {
    SetLastError(USERERR|GL_INVALID_OPERATION);
    return 0;
  }
