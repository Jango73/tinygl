...
typedef struct tag_GLDEVICEINFO
{
  HDC         Handle;
  GLI32       Version;
  GLI32       Technology;
  ...
  GLI32       ColorRes;
  GLI32       RasterCaps;
} GLDEVICEINFO, *LPGLDEVICEINFO;

/*****************************************************************************************************/

typedef struct tag_GLDIBSECTION
{
  HBITMAP     Handle;
  GLU8*       Base;
} GLDIBSECTION, LPGLDIBSECTION;

/*****************************************************************************************************/

typedef struct tag_GLRENDERCONTEXT
{
  GLU32               Id;
  ...
  GLU32               NumLists;
  GLLIST              RenderList;
} GLRENDERCONTEXT, *LPGLRENDERCONTEXT;
...
#define RGB_TO_RGB888(r,g,b) (((GLI32)r<<16)|((GLI32)g<<8)|((GLI32)b<<0))

/*****************************************************************************************************/

extern HGLOBAL                GlRenderContext[GL_MAX_CONTEXT];
extern GLI32                  GlNumContext;
extern HGLRC                  GlCurrentHandle;
