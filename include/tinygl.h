...
#if defined(TINYGL_SHARED)
#if defined(TINYGL_BUILD)
...
#else
#define APIENTRY
#if defined(TINYGL_SHARED) && defined(TINYGL_BUILD)
...
typedef struct TGL_CONTEXT TGL_CONTEXT;

typedef TGL_CONTEXT *TGLContext;

typedef enum TGL_RESULT {
    TGL_RESULT_OK = 0,
    TGL_RESULT_INVALID_ARGUMENT,
    TGL_RESULT_INVALID_OPERATION,
    TGL_RESULT_OUT_OF_MEMORY,
    TGL_RESULT_UNSUPPORTED,
    TGL_RESULT_INTERNAL_ERROR
} TGL_RESULT;

typedef enum TGL_ERROR {
    TGL_ERROR_NONE = 0,
    TGL_ERROR_INVALID_ARGUMENT,
    TGL_ERROR_INVALID_CONTEXT,
    TGL_ERROR_INVALID_SURFACE,
    TGL_ERROR_OUT_OF_MEMORY,
    TGL_ERROR_INTERNAL
} TGL_ERROR;

typedef enum TGL_PIXEL_FORMAT {
    TGL_PIXEL_FORMAT_INVALID = 0,
    TGL_PIXEL_FORMAT_XRGB8888,
    TGL_PIXEL_FORMAT_ARGB8888,
    TGL_PIXEL_FORMAT_RGB565,
    TGL_PIXEL_FORMAT_XBGR8888
} TGL_PIXEL_FORMAT;

typedef enum TGL_SURFACE_MODE {
    TGL_SURFACE_MODE_NONE = 0,
    TGL_SURFACE_MODE_HOST_PROVIDED,
    TGL_SURFACE_MODE_INTERNAL
} TGL_SURFACE_MODE;

typedef enum TGL_PRESENT_RESULT {
    TGL_PRESENT_RESULT_OK = 0,
    TGL_PRESENT_RESULT_NO_SURFACE,
    TGL_PRESENT_RESULT_NOT_SUPPORTED,
    TGL_PRESENT_RESULT_FAILED
} TGL_PRESENT_RESULT;

typedef struct TGL_SURFACE_DESC {
    void *Pixels;
    GLsizei Width;
    GLsizei Height;
    GLsizei Pitch;
...
typedef struct TGL_CONTEXT_DESC {
    GLsizei MaxWidth;
    GLsizei MaxHeight;
...
typedef void(APIENTRY *TGL_NOTIFY_RESIZE_PROC)(void *UserData,
                                               const TGL_SURFACE_DESC *Surface);
typedef void(APIENTRY *TGL_NOTIFY_ERROR_PROC)(void *UserData,
                                              TGL_ERROR Error);

typedef struct TGL_BRIDGE_CALLBACKS {
    TGL_PRESENT_PROC Present;
    TGL_NOTIFY_RESIZE_PROC NotifyResize;
    TGL_NOTIFY_ERROR_PROC NotifyError;
    void *UserData;
...
#define GL_INTERNAL_ERROR 0x0506
...
EXPORT TGL_RESULT APIENTRY tinyglSetSurface(
    TGLContext Context, const TGL_SURFACE_DESC *Surface);
...
EXPORT TGL_RESULT APIENTRY tinyglGetSurface(
    TGLContext Context, TGL_SURFACE_DESC *Surface);
EXPORT TGL_SURFACE_MODE APIENTRY tinyglGetSurfaceMode(TGLContext Context);
EXPORT TGL_RESULT APIENTRY tinyglSetBridgeCallbacks(
    TGLContext Context, const TGL_BRIDGE_CALLBACKS *Callbacks);
EXPORT TGL_PRESENT_RESULT APIENTRY tinyglPresent(TGLContext Context);
EXPORT TGL_ERROR APIENTRY tinyglGetLastError(void);
EXPORT void APIENTRY tinyglClearLastError(void);
...
EXPORT void APIENTRY glBitmap(GLsizei width, GLsizei height, GLfloat xorig,
...
EXPORT void APIENTRY glColor4b(GLbyte red, GLbyte green, GLbyte blue,
                               GLbyte alpha);
EXPORT void APIENTRY glColor4bv(const GLbyte *v);
EXPORT void APIENTRY glColor4d(GLdouble red, GLdouble green, GLdouble blue,
                               GLdouble alpha);
EXPORT void APIENTRY glColor4dv(const GLdouble *v);
EXPORT void APIENTRY glColor4f(GLfloat red, GLfloat green, GLfloat blue,
                               GLfloat alpha);
...
EXPORT void APIENTRY glColor4s(GLshort red, GLshort green, GLshort blue,
                               GLshort alpha);
EXPORT void APIENTRY glColor4sv(const GLshort *v);
EXPORT void APIENTRY glColor4ub(GLubyte red, GLubyte green, GLubyte blue,
                                GLubyte alpha);
EXPORT void APIENTRY glColor4ubv(const GLubyte *v);
EXPORT void APIENTRY glColor4ui(GLuint red, GLuint green, GLuint blue,
                                GLuint alpha);
EXPORT void APIENTRY glColor4uiv(const GLuint *v);
EXPORT void APIENTRY glColor4us(GLushort red, GLushort green, GLushort blue,
                                GLushort alpha);
EXPORT void APIENTRY glColor4usv(const GLushort *v);
EXPORT void APIENTRY glColorMask(GLboolean red, GLboolean green, GLboolean blue,
                                 GLboolean alpha);
EXPORT void APIENTRY glColorMaterial(GLenum face, GLenum mode);
EXPORT void APIENTRY glCopyPixels(GLint x, GLint y, GLsizei width,
...
EXPORT void APIENTRY glDrawPixels(GLsizei width, GLsizei height, GLenum format,
...
EXPORT void APIENTRY glEvalMesh2(GLenum mode, GLint i1, GLint i2, GLint j1,
                                 GLint j2);
EXPORT void APIENTRY glEvalPoint1(GLint i);
EXPORT void APIENTRY glEvalPoint2(GLint i, GLint j);
EXPORT void APIENTRY glFeedbackBuffer(GLsizei size, GLenum type,
                                      GLfloat *buffer);
...
EXPORT void APIENTRY glGetMaterialfv(GLenum face, GLenum pname,
                                     GLfloat *params);
...
EXPORT void APIENTRY glGetTexEnvfv(GLenum target, GLenum pname,
                                   GLfloat *params);
EXPORT void APIENTRY glGetTexEnviv(GLenum target, GLenum pname, GLint *params);
EXPORT void APIENTRY glGetTexGendv(GLenum coord, GLenum pname,
                                   GLdouble *params);
...
EXPORT void APIENTRY glGetTexImage(GLenum target, GLint level, GLenum format,
                                   GLenum type, GLvoid *pixels);
EXPORT void APIENTRY glGetTexLevelParameterfv(GLenum target, GLint level,
                                              GLenum pname, GLfloat *params);
EXPORT void APIENTRY glGetTexLevelParameteriv(GLenum target, GLint level,
                                              GLenum pname, GLint *params);
EXPORT void APIENTRY glGetTexParameterfv(GLenum target, GLenum pname,
                                         GLfloat *params);
EXPORT void APIENTRY glGetTexParameteriv(GLenum target, GLenum pname,
                                         GLint *params);
...
EXPORT void APIENTRY glMap1d(GLenum target, GLdouble u1, GLdouble u2,
                             GLint stride, GLint order, const GLdouble *points);
EXPORT void APIENTRY glMap1f(GLenum target, GLfloat u1, GLfloat u2,
                             GLint stride, GLint order, const GLfloat *points);
EXPORT void APIENTRY glMap2d(GLenum target, GLdouble u1, GLdouble u2,
                             GLint ustride, GLint uorder, GLdouble v1,
                             GLdouble v2, GLint vstride, GLint vorder,
                             const GLdouble *points);
EXPORT void APIENTRY glMap2f(GLenum target, GLfloat u1, GLfloat u2,
...
EXPORT void APIENTRY glMapGrid2d(GLint un, GLdouble u1, GLdouble u2, GLint vn,
                                 GLdouble v1, GLdouble v2);
EXPORT void APIENTRY glMapGrid2f(GLint un, GLfloat u1, GLfloat u2, GLint vn,
...
EXPORT void APIENTRY glPixelMapfv(GLenum map, GLsizei mapsize,
                                  const GLfloat *values);
EXPORT void APIENTRY glPixelMapuiv(GLenum map, GLsizei mapsize,
                                   const GLuint *values);
EXPORT void APIENTRY glPixelMapusv(GLenum map, GLsizei mapsize,
...
EXPORT void APIENTRY glRasterPos4d(GLdouble x, GLdouble y, GLdouble z,
                                   GLdouble w);
...
EXPORT void APIENTRY glReadPixels(GLint x, GLint y, GLsizei width,
                                  GLsizei height, GLenum format, GLenum type,
                                  GLvoid *pixels);
EXPORT void APIENTRY glRectd(GLdouble x1, GLdouble y1, GLdouble x2,
                             GLdouble y2);
...
EXPORT void APIENTRY glTexCoord4d(GLdouble s, GLdouble t, GLdouble r,
                                  GLdouble q);
...
EXPORT void APIENTRY glTexEnvfv(GLenum target, GLenum pname,
                                const GLfloat *params);
EXPORT void APIENTRY glTexEnvi(GLenum target, GLenum pname, GLint param);
EXPORT void APIENTRY glTexEnviv(GLenum target, GLenum pname,
                                const GLint *params);
EXPORT void APIENTRY glTexGend(GLenum coord, GLenum pname, GLdouble param);
EXPORT void APIENTRY glTexGendv(GLenum coord, GLenum pname,
                                const GLdouble *params);
EXPORT void APIENTRY glTexGenf(GLenum coord, GLenum pname, GLfloat param);
EXPORT void APIENTRY glTexGenfv(GLenum coord, GLenum pname,
                                const GLfloat *params);
EXPORT void APIENTRY glTexGeni(GLenum coord, GLenum pname, GLint param);
EXPORT void APIENTRY glTexGeniv(GLenum coord, GLenum pname,
                                const GLint *params);
EXPORT void APIENTRY glTexImage1D(GLenum target, GLint level, GLint components,
                                  GLsizei width, GLint border, GLenum format,
                                  GLenum type, const GLvoid *pixels);
EXPORT void APIENTRY glTexImage2D(GLenum target, GLint level, GLint components,
                                  GLsizei width, GLsizei height, GLint border,
                                  GLenum format, GLenum type,
                                  const GLvoid *pixels);
EXPORT void APIENTRY glTexParameterf(GLenum target, GLenum pname,
                                     GLfloat param);
EXPORT void APIENTRY glTexParameterfv(GLenum target, GLenum pname,
                                      const GLfloat *params);
EXPORT void APIENTRY glTexParameteri(GLenum target, GLenum pname, GLint param);
EXPORT void APIENTRY glTexParameteriv(GLenum target, GLenum pname,
                                      const GLint *params);
